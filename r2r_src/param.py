...
class Param:
    def __init__(self):
        ...
        # Add
        self.parser.add_argument("--tree", dest='tree', type=str, default='none')   #con: constituency dep:dependency combine:combine con+dep
        self.parser.add_argument("--lstm_layer", default=1, type=int)
        self.parser.add_argument("--dataset", type=str, default='R2R')
        self.parser.add_argument("--tree_layer", default=1, type=int)
        self.parser.add_argument("--language", dest='language', type=str, default='en-IN')
